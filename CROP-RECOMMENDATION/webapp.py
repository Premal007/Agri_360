...
def main():  
    ...
    if st.sidebar.button("Predict"):
        if not inputs.any() or np.isnan(inputs).any() or (inputs == 0).all():
            ...
            irrigation_mapping = {
                'rice': 'Flood irrigation (traditional) / SRI with alternate wetting & drying',
                'maize': 'Furrow / sprinkler irrigation',
                'chickpea': 'Sprinkler / surface irrigation',
                'kidneybeans': 'Sprinkler / furrow irrigation',
                'pigeonpeas': 'Rainfed / supplemental sprinkler',
                'mothbeans': 'Rainfed / limited sprinkler irrigation',
                'mungbean': 'Sprinkler / light surface irrigation',
                'blackgram': 'Sprinkler or surface irrigation',
                'lentil': 'Sprinkler / surface irrigation',
                ...
                'coconut': 'Basin or drip irrigation',
                'cotton': 'Drip Irrigation',
                'jute': 'Surface irrigation',
                'coffee': 'Sprinkler or drip irrigation'
            }
            st.success(f"The recommended irrigation type is: {irrigation_mapping.get(prediction[0], 'Not available')}")
